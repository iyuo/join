...
1. Add a new remote that points to the original project so you can sync project changes with your local copy:
   ...
   ```shell
   $ git remote add upstream https://github.com/iyuo/join
   ```
...
[issues]: https://github.com/iyuo/join/issues
[pull-requests]: https://github.com/iyuo/join/pulls
[code-of-conduct]: ./CODE_OF_CONDUCT.md
[about]: https://iyuo.github.io/join/
