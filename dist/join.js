(function (global, factory) {
  ...
  (function (JoinTypes) {
      ...
      JoinTypes[JoinTypes["midLeft"] = 4] = "midLeft";
      JoinTypes[JoinTypes["midRight"] = 2] = "midRight";
      JoinTypes[JoinTypes["midMerge"] = 6] = "midMerge";
  ...
  function joinSource(withObject, joinType) {
      ...
      if (joinType === (exports.JoinTypes.left | exports.JoinTypes.midLeft)) {
          return this;
      }
      var names = getPartNames(this, withObject);
      //merge
      switch (joinType & exports.JoinTypes.midMerge) {
          case exports.JoinTypes.none:
              clearNames(this, names.middle);
              break;
          case exports.JoinTypes.midLeft:
              break;
          case exports.JoinTypes.midRight:
              attach(this, withObject, names.middle);
              break;
          case exports.JoinTypes.midMerge:
  ...
  function join(joinType, withObject) {
      return function () {
